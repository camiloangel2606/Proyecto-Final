...
public class DietPlan {
    ...
    public DietPlan(int planId, int dailyCalories, String macronutrientDistribution, String specificRecommendations, Patient patient, Dietitian dietitian, List<Meal> meals) {
        this.planId = planId;
    ...
    public String toString() {
        return "DietPlan[PlanId:" + planId + ", DailyCalories:" + dailyCalories + ", MacronutrientDistribution:" + macronutrientDistribution + ", SpecificRecommendations:" + specificRecommendations + ", Patient:" + patient + ", Dietitian:" + dietitian + ", Meals:" + meals + "]";
    }
}